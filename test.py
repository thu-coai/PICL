...
# print(input_ids[0])
# print(model_batch["position_ids"][0])
# print(icl_batch["input_ids"][0])
# print(list(map(len, icl_batch["input_ids"])))
# print(icl_batch["position_ids"])
# print(inner_inputs[0][0]["position_ids"][2])
...
# all_option_ids = defaultdict(int)

# with open("/home/guyuxian/CodeRepo/data/poem_sentiment/cache/icl_new_cache/train/1/10000/256/42/poem_sentiment_1/origin/bos/data.pkl", "rb") as f:
#     data = pickle.load(f)
    
# for d in data:
#     all_option_ids[d["option_label_id"]] += 1

# # all_option_ids = set(all_option_ids)

# print(all_option_ids)

# import numpy as np

# model_data = torch.load("model_data.pt", map_location="cpu")
# no_model_data = torch.load("no_model_data.pt", map_location="cpu")
# all_s = torch.load("all_s.pt", map_location="cpu")
# print({i:s for i, s in enumerate(all_s)})

# idx = 23

# L = model_data["input_ids"][idx].tolist()
# # print(L)
# L = L[:L.index(50256)]
# print(L)
# print(tokenizer.decode(L))

# def _split_input_ids(input_ids):
#     assert input_ids[-1] == 198
#     split_input_ids = []
#     b, e = 0, 0
...
# def _get_lcs_start(demo_ids, test_input_ids):
#     l = 0
...
# L = L + [198]
# split_input_ids = _split_input_ids(L)

# for x in split_input_ids:
#     print(x)

# demo_ids = split_input_ids[:-1]
# test_input_ids = split_input_ids[-1]

# s = _get_lcs_start(demo_ids, test_input_ids)

# print(s)

# label = no_model_data["label"][idx]

# print(label.tolist())

# mask = (label != -100)

# valid_L = torch.masked_select(model_data["input_ids"][idx], mask)

# print(valid_L)


# model_batch, no_model_batch = torch.load("/home/guyuxian/CodeRepo/icl_train/mb_few.pt", map_location="cpu")

# idx = 0

# input_ids = model_batch["input_ids"].tolist()
# print(input_ids[idx])
# print(tokenizer.decode(input_ids[idx]))

# label = no_model_batch["label"].tolist()
# print(label[idx])
...
# print(no_model_batch["loss_mask"][idx].tolist())
# loss_mask = torch.where(no_model_batch["loss_mask"] < 0.5, 100, no_model_batch["loss_mask"])
# print(loss_mask[idx].tolist())

# print(no_model_batch["label"][idx].tolist())

# mb = torch.load("/home/lidong1/CodeRepo/icl_train/results/pretrain/general_10M_128_256_roberta-bHR_en1_hn1_cat32_bs64_lr0.00005_G1_4000.pt_r2s<n>_/vanilla/all_target/chunk-1/pos0_<n>/shot16/lr1e-06-bs2-G16-N16-wm0/len256-1024-None/gpt2-large/10-10-42/model_batch_8.pt", map_location="cpu")

# print(mb["input_ids"])

# print()
# print(tokenizer.decode(mb["input_ids"][1]))
# print()

mb = torch.load("/home/lidong1/CodeRepo/icl_train/results_new/pretrain/general_full_256_SEARCH1_r2s_10M/lm_data_full_stuffed_rr_1.0/vanilla/all_target/chunk-1/pos0_nn/shot16/lr1e-06-bs1-G16-N4-wm0/len256-1024-None/gpt2-large/10-10-42/model_batch_3.pt", map_location="cpu")
