...
p_name = "MSRA Prompt 3"

new_template = Template(
    name=p_name,
    jinja="Passage: {{passage}}\nQuestion: {{question}}\nLabel: ||| {% if label != -1 %}{{ answer_choices[label] }}{% endif %}",
    reference="gyx",
...
templates = collection.get_dataset("super_glue", "boolq")
...
data_files = {
    "validation": "/home/lidong1/CodeRepo/data/boolq/cache/validation.jsonl",
}
