...
p_name = "MSRA Prompt (Gen)"

new_template = Template(
    name=p_name,
    jinja="Passsage: {{context}}\nQuestion: ||| {{question}}",
    reference="gyx",
...
templates = collection.get_dataset("squad", None)
...
data_files = {
    "validation": "/home/lidong1/CodeRepo/data/squad/cache/validation.jsonl",
}
