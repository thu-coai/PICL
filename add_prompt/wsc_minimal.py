...
new_template = Template(
    name=p_name,
    jinja="{{ text }} span1: {{ span1_text }}. span2: {{ span2_text }}. ||| {% if label != -1 %}{{ answer_choices[label] }}{% endif %}",
    reference="gyx",
...
templates = collection.get_dataset("super_glue", "wsc.fixed")
...
data_files = {
    "validation": "/home/guyuxian/data_hf/wsc/cache/validation.jsonl",
}
...
print()
print(x[0] + templates[p_name].metadata.concate_str + x[1].strip() + "\n")
