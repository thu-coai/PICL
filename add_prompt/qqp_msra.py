...
new_template = Template(
    name=p_name,
    jinja="Question 1: {{question1}} Question 2: {{question2}}\nLabel: ||| {{ answer_choices[label] }}",
    reference="gyx",
...
templates = collection.get_dataset("glue", "qqp")
...
data_files = {
    "validation": "/home/lidong1/CodeRepo/data/qqp/cache/validation.jsonl",
}
