...
new_template = Template(
    ...
    answer_choices="company ||| school ||| artist ||| athlete ||| politics ||| transportation ||| building ||| nature ||| village ||| animal ||| plant ||| album ||| film ||| book"
)

templates = collection.get_dataset("dbpedia_14", None)
...
data_files = {
    "validation": "/home/lidong1/CodeRepo/data/dbpedia_14/cache/validation.jsonl",
}
