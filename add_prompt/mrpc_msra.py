...
new_template = Template(
    name=p_name,
    jinja="Sentence 1: {{sentence1}} Sentence 2: {{sentence2}}\nLabel: ||| {{ answer_choices[label] }}",
    reference="gyx",
...
templates = collection.get_dataset("glue", "mrpc")
...
data_files = {
    "validation": "/home/lidong1/CodeRepo/data/mrpc/cache/validation.jsonl",
}
