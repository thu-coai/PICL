...
new_template = Template(
    name=p_name,
    jinja="Question: {{question_stem}}\nAnswer: ||| {{answer_choices[{\"A\":0,\"B\":1,\"C\":2,\"D\":3}[answerKey]]}}",
    reference="gyx",
...
templates = collection.get_dataset("openbookqa", "main")
...
data_files = {
    "validation": "/home/lidong1/CodeRepo/data/openbookqa/cache/main/validation.jsonl",
}
