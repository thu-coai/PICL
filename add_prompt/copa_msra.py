...
new_template = Template(
    name=p_name,
    jinja="{% if question == \"cause\" %}Effect: {{ premise }}\nCause: {% else %}Cause: {{ premise }}\nEffect: {% endif %} ||| {% if label != -1 %}{{ answer_choices[label] }}{% endif %}",
    reference="gyx",
...
data_files = {
    "validation": "/home/lidong1/CodeRepo/data/copa/cache/validation.jsonl",
}
