...
SAVE_PATH="${BASE_PATH}/icl_train/results_new_data/infer/${DATA_NAMES}/${TYPE}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/ml${MAX_LENGTH_PER_SAMPLE}_${MAX_LENGTH}_${MAX_LENGTH_ALL_DEMOS}/share-balance/"
