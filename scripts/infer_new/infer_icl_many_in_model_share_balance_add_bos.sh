...
SEED=${3-10}
SEED_ORDER=${4-10}
TYPE="many_add_bos_remove_inner_bos"
# PROMPT=${7-"Simple_Prompt_2"}
# END_TOKEN=${8-"<n>"}
CHUNK_LEN=1024
POS_TYPE=3
EVAL_BATCH_SIZE=2
...
SAVE_PATH="${BASE_PATH}/icl_train/results_cache/infer/${DATA_NAMES}/${TYPE}_${POS_TYPE}/chunk${CHUNK_LEN}_end${END_TOKEN}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/share-balance/"
