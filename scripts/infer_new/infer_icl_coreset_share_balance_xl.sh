...
SAVE_PATH="${BASE_PATH}/icl_train/results_cache/infer/${DATA_NAMES}/${TYPE}_${POS_TYPE}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/ml${MAX_LENGTH_PER_SAMPLE}_${MAX_LENGTH}_${MAX_LENGTH_ALL_DEMOS}/share-balance/"
