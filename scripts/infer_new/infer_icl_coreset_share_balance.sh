...
SAVE_PATH="${BASE_PATH}/icl_train/results_cache/infer/${DATA_NAMES}/${TYPE}_${POS_TYPE}/chunk${CHUNK_LEN}_end${END_TOKEN}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/ml${MAX_LENGTH_PER_SAMPLE}_${MAX_LENGTH}_${MAX_LENGTH_ALL_DEMOS}/share-balance/"
...
OPTS+=" --train-prompts ${PROMPT}"
OPTS+=" --eval-prompts ${PROMPT}"
OPTS+=" --pos-type ${POS_TYPE}"
OPTS+=" --type ${TYPE}"
OPTS+=" --end-token ${END_TOKEN}"
OPTS+=" --attn-scale"
