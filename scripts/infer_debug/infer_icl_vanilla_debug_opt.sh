...
CKPT_NAME=${7-"opt-2.7B"}
CKPT="${BASE_PATH}/icl_train/results_new/${CKPT_NAME}/"
# data
DATA_NAMES="sst2_eval-subj_eval_4-mr_eval_2-rte_eval-ag_news_eval_6-cb_eval_3"
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/icl_train/finetune_opt_few_ds.py ${OPTS} $@"
