...
CKPT_NAME="MCQA-EXQA-CBQA-TC-PARA/few_unordered_2/test_target/16/gpt2-large/10-10/lr0.00005_bs2_G128_ml1024/1000"
CKPT="${BASE_PATH}/icl_train/results_new/train/${CKPT_NAME}"
SEED=${3-10}
SEED_ORDER=${4-10}
TYPE="many"
POS_TYPE=2
...
SAVE_PATH="${BASE_PATH}/icl_train/results_new/infer/${DATA_NAMES}/${TYPE}_${POS_TYPE}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/share-balance/"
