...
# data
DATA_PREFIX=${4-"general/10M_128/256/roberta-base/HR/pos1_easy_neg1_hard_neg1_seed42_concate32/bs64_32_lr0.00005_G1_SEED/4000.pt/l2_h5/res_-1/r2s<n>/"}
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/icl_train/pretrain_gpt2_many_ds.py ${OPTS} $@"
