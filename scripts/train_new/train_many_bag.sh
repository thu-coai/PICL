...
EVAL_BATCH_SIZE=16
MAX_LENGTH=-1
MAX_LENGTH_ALL_DEMOS=1024
MAX_LENGTH_PER_SAMPLE=256
LR=0.00005
GRAD_ACC=256
SHOT=16

SAVE_PATH="${BASE_PATH}/icl_train/results_cache/train/${DATA_NAMES}/${TYPE}_pos${POS_TYPE}/${ICL_SUP}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/lr${LR}_bs${BATCH_SIZE}_G${GRAD_ACC}_ml${MAX_LENGTH_PER_SAMPLE}_${MAX_LENGTH}_${MAX_LENGTH_ALL_DEMOS}"
