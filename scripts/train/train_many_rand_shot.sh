...
EVAL_BATCH_SIZE=8
MAX_LENGTH=256
ICL_TRAIN_MAX_LENGTH=2048
LR=0.00005
GRAD_ACC=8
SHOT=8

SAVE_PATH="${BASE_PATH}/icl_train/results_new/train/${DATA_NAMES}/${TYPE}/${ICL_SUP}/${SHOT}_rand/${CKPT}/${SEED}-${SEED_ORDER}/lr${LR}_bs${BATCH_SIZE}_G${GRAD_ACC}_ml${MAX_LENGTH}"
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/icl_train/finetune_gpt2_unordered.py ${OPTS}"
