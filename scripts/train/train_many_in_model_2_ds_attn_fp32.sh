...
CKPT_NAME="MCQA-EXQA-CBQA-TC-PARA/many_in_model_2_attn_32_2/test_target/16/gpt2-large/10-10/lr0.00005_bs1_G256_ml256/200"
CKPT="/home/guyuxian/CodeRepo/icl_train/results_new/train/${CKPT_NAME}"

SEED=${3-10}
SEED_ORDER=${4-10}
TYPE="many_in_model_2_attn_32"
POS_TYPE=2
ICL_SUP=${5-test_target}
BATCH_SIZE=1
EVAL_BATCH_SIZE=16
MAX_LENGTH=256
ICL_TRAIN_MAX_LENGTH=1024
LR=0.00005
GRAD_ACC=256
SHOT=16

SAVE_PATH="${BASE_PATH}/icl_train/results_new/train/${DATA_NAMES}/${TYPE}_pos${POS_TYPE}/${ICL_SUP}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/lr${LR}_bs${BATCH_SIZE}_G${GRAD_ACC}_ml${MAX_LENGTH}"
