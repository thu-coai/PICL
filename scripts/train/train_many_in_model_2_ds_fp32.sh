...
SEED=${3-10}
SEED_ORDER=${4-10}
TYPE="many_in_model_2"
POS_TYPE=2
ICL_SUP=${5-test_target}
BATCH_SIZE=1
EVAL_BATCH_SIZE=16
MAX_LENGTH=256
ICL_TRAIN_MAX_LENGTH=256
LR=0.00005
GRAD_ACC=16
SHOT=16

SAVE_PATH="${BASE_PATH}/icl_train/results_new/train_fp32/${DATA_NAMES}/${TYPE}_${POS_TYPE}/${ICL_SUP}/${SHOT}/${CKPT_NAME}/${SEED}-${SEED_ORDER}/lr${LR}_bs${BATCH_SIZE}_G${GRAD_ACC}_ml${MAX_LENGTH}"
...
OPTS+=" --deepspeed"
OPTS+=" --deepspeed_config ${BASE_PATH}/icl_train/configs/deepspeed/ds_config_fp32.json"
