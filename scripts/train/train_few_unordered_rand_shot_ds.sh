...
SAVE_PATH="${BASE_PATH}/icl_train/results_new/train/${DATA_NAMES}/${TYPE}_${POS_TYPE}/${ICL_SUP}/${SHOT}_rand/${CKPT_NAME}/${SEED}-${SEED_ORDER}/lr${LR}_bs${BATCH_SIZE}_G${GRAD_ACC}_ml${MAX_LENGTH}"
