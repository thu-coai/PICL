...
class Glue(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        if self.config.name == "mrpc":
            data_dir = None
            mrpc_files = {
                    "dev_ids": "/home/guyuxian/data_hf/mrpc/mrpc_dev_ids.tsv",
                    "train": "/home/guyuxian/data_hf/mrpc/msr_paraphrase_train.txt",
                    "test": "/home/guyuxian/data_hf/mrpc/msr_paraphrase_test.txt",
                }
        else:
            # dl_dir = dl_manager.download_and_extract(self.config.data_url)
            dl_dir = os.path.join("/home/guyuxian/data_hf/", self.config.name)
