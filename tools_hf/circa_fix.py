...
class Circa(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        train_path = "/home/guyuxian/data_hf/circa/circa-data.tsv"
        return [
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for id_, row in enumerate(data):
                ...
                yield id_, {
                    ...
                    "goldstandard1": goldstandard2, # from https://github.com/facebookresearch/MetaICL/blob/main/preprocess/utils.py#L159
