...
class Codah(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        if self.config.name == "codah":
            ...
            data_file = "/home/guyuxian/data_hf/codah/full_data.tsv"
        ...
        downloaded_files = {
            "train": f"/home/guyuxian/data_hf/codah/{self.config.fold}/train.tsv",
            "dev": f"/home/guyuxian/data_hf/codah/{self.config.fold}/dev.tsv",
            "test": f"/home/guyuxian/data_hf/codah/{self.config.fold}/test.tsv",
        }
