...
class StoryCloze(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        path_to_manual_folder = "/home/guyuxian/data_hf/story_cloze/"

        if self.config.name == "2016":
            test_file = os.path.join(path_to_manual_folder, "cloze_test_spring2016-test.csv")
            val_file = os.path.join(path_to_manual_folder, "cloze_test_val__spring2016_cloze_test_ALL_val.csv")
            return [
            ...
            val_file = os.path.join(path_to_manual_folder, "test_nlu18_utf-8.csv")
