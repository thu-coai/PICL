...
class HotpotQA(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        base_dir = "/home/guyuxian/data_hf/hotpot_qa/"
        files = {
            datasets.Split.TRAIN: base_dir + "hotpot_train_v1.1.json",
            datasets.Split.VALIDATION: base_dir + "hotpot_dev_" + self.config.name + "_v1.json",
        }
        if self.config.name == "fullwiki":
            files[datasets.Split.TEST] = base_dir + "hotpot_test_fullwiki_v1.json"
