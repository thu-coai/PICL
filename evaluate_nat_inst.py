...
def evaluate_gen(args, tokenizer: GPT2Tokenizer, model: GPT2LMHeadModel, dataset: NIEvalDataset, epoch, device):
...
def evaluate_yn(args, tokenizer: GPT2Tokenizer, model: GPT2LMHeadModel, dataset: NIEvalDataset, epoch, device):
