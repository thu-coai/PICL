...
def process_data(args):
    for ith in range(0, 100):
        ...
        train_bin_file = os.path.join(args.processed_output, f"train_lm_{ith}.bin")
        train_idx_file = os.path.join(args.processed_output, f"train_lm_{ith}.idx")
    
        valid_bin_file = os.path.join(args.processed_output, f"valid_lm_{ith}.bin")
        valid_idx_file = os.path.join(args.processed_output, f"valid_lm_{ith}.idx")
